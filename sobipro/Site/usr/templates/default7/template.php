...
abstract class tplDefault7
{
	...
	{
		SPFactory::header()->addCSSCode( ".SobiPro.default7 {font-family:'" . $name . "', sans serif;}" );
	}
	...
	{
		SPFactory::header()->addCSSCode( ".SobiPro.default7 h1, .SobiPro.default7 h2, .SobiPro.default7 h3, .SobiPro.default7 h4 {font-family:'" . $name . "', sans serif;}" );
	}
