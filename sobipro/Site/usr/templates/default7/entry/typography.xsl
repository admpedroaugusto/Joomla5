...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:php="http://php.net/xsl" exclude-result-prefixes="php">
	...
	<xsl:template match="/entry_details">
		...
		<xsl:if test="not($bs = 4) and not($bs = 5) or not($font = 'fa5')">
			<div class="alert alert-delta">
				The typography page needs Bootstrap 4 or Bootstrap 5 and Font Awesome 5 to be set in the section configuration.
				<br/>
		...
		<div class="d-flex">
			<xsl:choose>
				...
				<xsl:otherwise> <!-- Bootstrap 4 -->
					<span class="badge badge-secondary me-1">badge-secondary</span>
					<span class="badge badge-alpha me-1">badge-alpha</span>
					<span class="badge badge-beta me-1 ">badge-beta</span>
					<span class="badge badge-gamma me-1">badge-gamma</span>
					<span class="badge badge-delta me-1">badge-delta</span>
					<span class="badge badge-alpha badge-pill me-1">badge-alpha badge-pill</span>
					<span class="badge badge-beta badge-pill me-1 ">badge-beta badge-pill</span>
					<span class="badge badge-gamma badge-pill me-1">badge-gamma badge-pill</span>
					<span class="badge badge-delta badge-pill me-1">badge-delta badge-pill</span>
				</xsl:otherwise>
			</xsl:choose>
		</div>
		...
		<div class="d-flex">
			<xsl:choose>
				...
				<xsl:otherwise> <!-- Bootstrap 4 -->
					<a href="#" class="badge badge-secondary me-1">badge-secondary</a>
					<a href="#" class="badge badge-alpha me-1">badge-alpha</a>
					<a href="#" class="badge badge-beta me-1 ">badge-beta</a>
					<a href="#" class="badge badge-gamma me-1">badge-gamma</a>
					<a href="#" class="badge badge-delta me-1">badge-delta</a>
				</xsl:otherwise>
			</xsl:choose>
		</div>
		...
		<div class="d-flex">
			<xsl:choose>
				...
				<xsl:otherwise> <!-- Bootstrap 4 -->
					<span class="badge badge-outline-alpha me-1">badge-alpha-light</span>
					<span class="badge badge-outline-beta me-1 ">badge-beta-light</span>
					<span class="badge badge-outline-gamma me-1">badge-gamma-light</span>
					<span class="badge badge-outline-delta me-1">badge-delta-light</span>
					<a class="badge badge-outline-alpha me-1">badge-alpha-light</a>
					<a class="badge badge-outline-beta me-1 ">badge-beta-light</a>
					<a class="badge badge-outline-gamma me-1">badge-gamma-light</a>
					<a class="badge badge-outline-delta me-1">badge-delta-light</a>
				</xsl:otherwise>
			</xsl:choose>
		</div>
				...
				<div class="btn-group me-2">
					<xsl:variable name="toggler">
						<xsl:choose>
							...
							<xsl:otherwise>
								<button type="button" class="btn btn-alpha dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									Action
								</button>
							</xsl:otherwise>
						</xsl:choose>
				...
				<div class="btn-group me-2">
					<xsl:variable name="toggler">
						<xsl:choose>
							...
							<xsl:otherwise>
								<button type="button" class="btn btn-beta dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									Action
								</button>
							</xsl:otherwise>
						</xsl:choose>
				...
				<div class="btn-group me-2">
					<xsl:variable name="toggler">
						<xsl:choose>
							...
							<xsl:otherwise>
								<button type="button" class="btn btn-gamma dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									Action
								</button>
							</xsl:otherwise>
						</xsl:choose>
				...
				<div class="btn-group">
					<xsl:variable name="toggler">
						<xsl:choose>
							...
							<xsl:otherwise>
								<button type="button" class="btn btn-delta dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									Action
								</button>
							</xsl:otherwise>
						</xsl:choose>
				...
				<div class="btn-group me-2">
					<xsl:variable name="toggler">
						<xsl:choose>
							...
							<xsl:otherwise>
								<button type="button" class="btn btn-alpha dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									<span class="sr-only visually-hidden">Toggle Dropdown</span>
								</button>
							</xsl:otherwise>
						</xsl:choose>
				...
				<div class="btn-group me-2">
					...
					<xsl:variable name="toggler">
						<xsl:choose>
							...
							<xsl:otherwise>
								<button type="button" class="btn btn-beta dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									<span class="sr-only visually-hidden">Toggle Dropdown</span>
								</button>
							</xsl:otherwise>
						</xsl:choose>
				...
				<div class="btn-group me-2">
					...
					<xsl:variable name="toggler">
						<xsl:choose>
							...
							<xsl:otherwise>
								<button type="button" class="btn btn-gamma dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									<span class="sr-only visually-hidden">Toggle Dropdown</span>
								</button>
							</xsl:otherwise>
						</xsl:choose>
				...
				<div class="btn-group">
					...
					<xsl:variable name="toggler">
						<xsl:choose>
							...
							<xsl:otherwise>
								<button type="button" class="btn btn-delta dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									<span class="sr-only visually-hidden">Toggle Dropdown</span>
								</button>
							</xsl:otherwise>
						</xsl:choose>
						...
						<xsl:when test="$bs = 5">
							<li class="nav-item" role="tablist">
								<a class="nav-link active" id="standard-tab" href="#standard" aria-controls="standard" data-bs-toggle="tab" role="tab" aria-selected="true">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Standard Tab' )"/>
								</a>
							</li>
							<li class="nav-item" role="tablist">
								<a class="nav-link" id="alpha-tab" href="#alpha" aria-controls="alpha" data-bs-toggle="tab" role="tab" aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Standard Tab (alpha)' )"/>
								</a>
							</li>
							<li class="nav-item" role="tablist">
								<a class="nav-link" id="beta-tab" href="#beta" aria-controls="beta" data-bs-toggle="tab" role="tab" aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Standard Tab (beta)' )"/>
								</a>
							</li>
							<li class="nav-item" role="tablist">
								<a class="nav-link" id="gamma-tab" href="#gamma" aria-controls="gamma" data-bs-toggle="tab" role="tab" aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Standard Tab (gamma)' )"/>
								</a>
							</li>
							<li class="nav-item" role="tablist">
								<a class="nav-link" id="delta-tab" href="#delta" aria-controls="delta" data-bs-toggle="tab" role="tab" aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Standard Tab (delta)' )"/>
								</a>
							</li>
						</xsl:when>
						<xsl:otherwise>
							<li class="nav-item" role="tablist">
								<a class="nav-link active" id="standard-tab" href="#standard" aria-controls="standard" data-toggle="tab" role="tab" aria-selected="true">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Standard Tab' )"/>
								</a>
							</li>
							<li class="nav-item" role="tablist">
								<a class="nav-link" id="alpha-tab" href="#alpha" aria-controls="alpha" data-toggle="tab" role="tab" aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Standard Tab (alpha)' )"/>
								</a>
							</li>
							<li class="nav-item" role="tablist">
								<a class="nav-link" id="beta-tab" href="#beta" aria-controls="beta" data-toggle="tab" role="tab" aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Standard Tab (beta)' )"/>
								</a>
							</li>
							<li class="nav-item" role="tablist">
								<a class="nav-link" id="gamma-tab" href="#gamma" aria-controls="gamma" data-toggle="tab" role="tab" aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Standard Tab (gamma)' )"/>
								</a>
							</li>
							<li class="nav-item" role="tablist">
						...
						<xsl:when test="$bs = 5">
							<li class="nav-item" role="tablist">
								<a class="nav-link active" id="coloured-tab" href="#coloured" aria-controls="coloured" data-bs-toggle="tab" role="tab" aria-selected="true">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Coloured Tab' )"/>
								</a>
							</li>
							<li class="nav-item nav-alpha" role="tablist">
								<a class="nav-link" id="alpha-coloured-tab" href="#alpha-coloured" aria-controls="alpha-coloured" data-bs-toggle="tab" role="tab"
								   aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Coloured Tab (alpha)' )"/>
								</a>
							</li>
							<li class="nav-item nav-beta" role="tablist">
								<a class="nav-link" id="beta-coloured-tab" href="#beta-coloured" aria-controls="beta-coloured" data-bs-toggle="tab" role="tab"
								   aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Coloured Tab (beta)' )"/>
								</a>
							</li>
							<li class="nav-item nav-gamma" role="tablist">
								<a class="nav-link" id="gamma-coloured-tab" href="#gamma-coloured" aria-controls="gamma-coloured" data-bs-toggle="tab" role="tab"
								   aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Coloured Tab (gamma)' )"/>
								</a>
							</li>
							<li class="nav-item nav-delta" role="tablist">
								<a class="nav-link" id="delta-coloured-tab" href="#delta-coloured" aria-controls="delta-coloured" data-bs-toggle="tab" role="tab"
								   aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Coloured Tab (delta)' )"/>
								</a>
							</li>
						</xsl:when>
						<xsl:otherwise>
							<li class="nav-item" role="tablist">
								<a class="nav-link active" id="coloured-tab" href="#coloured" aria-controls="coloured" data-toggle="tab" role="tab" aria-selected="true">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Coloured Tab' )"/>
								</a>
							</li>
							<li class="nav-item nav-alpha" role="tablist">
								<a class="nav-link" id="alpha-coloured-tab" href="#alpha-coloured" aria-controls="alpha-coloured" data-toggle="tab" role="tab"
								   aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Coloured Tab (alpha)' )"/>
								</a>
							</li>
							<li class="nav-item nav-beta" role="tablist">
								<a class="nav-link" id="beta-coloured-tab" href="#beta-coloured" aria-controls="beta-coloured" data-toggle="tab" role="tab" aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Coloured Tab (beta)' )"/>
								</a>
							</li>
							<li class="nav-item nav-gamma" role="tablist">
								<a class="nav-link" id="gamma-coloured-tab" href="#gamma-coloured" aria-controls="gamma-coloured" data-toggle="tab" role="tab"
								   aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Coloured Tab (gamma)' )"/>
								</a>
							</li>
							<li class="nav-item nav-delta" role="tablist">
								<a class="nav-link" id="delta-coloured-tab" href="#delta-coloured" aria-controls="delta-coloured" data-toggle="tab" role="tab"
								   aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Coloured Tab (delta)' )"/>
								</a>
							</li>
						...
						<xsl:when test="$bs = 5">
							<li class="nav-item" role="tablist">
								<a class="nav-link active" id="pills-tab" href="#pills" aria-controls="pills" data-bs-toggle="pill" role="tab" aria-selected="true">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Pills' )"/>
								</a>
							</li>
							<li class="nav-item nav-alpha" role="tablist">
								<a class="nav-link" id="alpha-pills-tab" href="#alpha-pills" aria-controls="alpha-pills" data-bs-toggle="pill" role="tab" aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Pills (alpha)' )"/>
								</a>
							</li>
							<li class="nav-item nav-beta" role="tablist">
								<a class="nav-link" id="beta-pills-tab" href="#beta-pills" aria-controls="beta-pills" data-bs-toggle="pill" role="tab" aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Pills (beta)' )"/>
								</a>
							</li>
							<li class="nav-item nav-gamma" role="tablist">
								<a class="nav-link" id="gamma-pills-tab" href="#gamma-pills" aria-controls="gamma-pills" data-bs-toggle="pill" role="tab" aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Pills (gamma)' )"/>
								</a>
							</li>
							<li class="nav-item nav-delta" role="tablist">
								<a class="nav-link" id="delta-pills-tab" href="#delta-pills" aria-controls="delta-pills" data-bs-toggle="pill" role="tab" aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Pills (delta)' )"/>
								</a>
							</li>
						</xsl:when>
						<xsl:otherwise>
							<li class="nav-item" role="tablist">
								<a class="nav-link active" id="pills-tab" href="#pills" aria-controls="pills" data-toggle="pill" role="tab" aria-selected="true">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Pills' )"/>
								</a>
							</li>
							<li class="nav-item nav-alpha" role="tablist">
								<a class="nav-link" id="alpha-pills-tab" href="#alpha-pills" aria-controls="alpha-pills" data-toggle="pill" role="tab" aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Pills (alpha)' )"/>
								</a>
							</li>
							<li class="nav-item nav-beta" role="tablist">
								<a class="nav-link" id="beta-pills-tab" href="#beta-pills" aria-controls="beta-pills" data-toggle="pill" role="tab" aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Pills (beta)' )"/>
								</a>
							</li>
							<li class="nav-item nav-gamma" role="tablist">
								<a class="nav-link" id="gamma-pills-tab" href="#gamma-pills" aria-controls="gamma-pills" data-toggle="pill" role="tab" aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Pills (gamma)' )"/>
								</a>
							</li>
							<li class="nav-item nav-delta" role="tablist">
								<a class="nav-link" id="delta-pills-tab" href="#delta-pills" aria-controls="delta-pills" data-toggle="pill" role="tab" aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Pills (delta)' )"/>
								</a>
							</li>
						</xsl:otherwise>
						...
						<xsl:when test="$bs = 5">
							...
							<li class="nav-item nav-beta" role="tablist">
								<a class="nav-link" id="beta-staples-tab" href="#beta-staples" aria-controls="beta-staples" data-bs-toggle="pill" role="tab" aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Staples (beta)' )"/>
								</a>
							</li>
							<li class="nav-item nav-gamma" role="tablist">
								<a class="nav-link" id="gamma-staples-tab" href="#gamma-staples" aria-controls="gamma-staples" data-bs-toggle="pill" role="tab"
								   aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Staples (gamma)' )"/>
								</a>
							</li>
							<li class="nav-item nav-delta" role="tablist">
								<a class="nav-link" id="delta-staples-tab" href="#delta-staples" aria-controls="delta-staples" data-bs-toggle="pill" role="tab"
								   aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Staples (delta)' )"/>
								</a>
							</li>
						</xsl:when>
						<xsl:otherwise>
							<li class="nav-item" role="tablist">
								<a class="nav-link active" id="staples-tab" href="#staples" aria-controls="staples" data-toggle="pill" role="tab" aria-selected="true">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Staples' )"/>
								</a>
							</li>
							<li class="nav-item nav-alpha" role="tablist">
								<a class="nav-link" id="alpha-staples-tab" href="#alpha-staples" aria-controls="alpha-staples" data-toggle="pill" role="tab" aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Staples (alpha)' )"/>
								</a>
							</li>
							<li class="nav-item nav-beta" role="tablist">
								<a class="nav-link" id="beta-staples-tab" href="#beta-staples" aria-controls="beta-staples" data-toggle="pill" role="tab" aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Staples (beta)' )"/>
								</a>
							</li>
							<li class="nav-item nav-gamma" role="tablist">
								<a class="nav-link" id="gamma-staples-tab" href="#gamma-staples" aria-controls="gamma-staples" data-toggle="pill" role="tab" aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Staples (gamma)' )"/>
								</a>
							</li>
							<li class="nav-item nav-delta" role="tablist">
								<a class="nav-link" id="delta-staples-tab" href="#delta-staples" aria-controls="delta-staples" data-toggle="pill" role="tab" aria-selected="false">
									<xsl:value-of select="php:function( 'SobiPro::Txt' , 'Staples (delta)' )"/>
								</a>
							</li>
						</xsl:otherwise>
