	...
	<xsl:template match="/payment_details">
		<div id="spctrl-payment-modal">
			<xsl:choose>
					...
					<div class="modal fade" tabindex="-1" aria-labelledby="sparia-title" aria-hidden="true">
						<div class="modal-dialog modal-lg modal-fullscreen-sm-down">
							<div class="modal-content">
								...
								<div class="modal-footer">
									<a href="#" class="btn btn-beta back" data-dismiss="modal" type="button">
										<xsl:value-of select="php:function( 'SobiPro::Txt', 'EN.PAYMENT_BACK_BT' )"/>
									</a>
									<a href="{/payment_details/save_url}" class="btn btn-delta" type="button">
										<xsl:value-of select="php:function( 'SobiPro::Txt', 'EN.PAYMENT_SAVE_ENTRY_BT' )"/>
				...
				<!-- Bootstrap 2 -->
				<xsl:otherwise>
					<div class="modal hide fade" tabindex="-1" aria-labelledby="sparia-title" aria-hidden="true">
						<div class="modal-header">
							<h3 id="sparia-title">
								<xsl:value-of select="php:function( 'SobiPro::Txt', 'PAYMENT_CHOSEN_FOLLOWING_OPTIONS' )"/>
							</h3>
